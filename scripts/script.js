...
function interviewSectionUpdate(card) {
    if (interviewCards.includes(card.id)) {
        ...
        allSection.childNodes.forEach(oldCard => {
            if (oldCard.id === card.id) {
                oldCard.classList.remove('rejected');
                oldCard.classList.add('interview');
                oldCard.querySelector('.currentStatus').innerHTML = 'Interview';
            }
        })
...
function rejectedSectionUpdate(card) {
    if (rejectedCards.includes(card.id)) {
        ...
        allSection.childNodes.forEach(oldCard => {
            if (oldCard.id === card.id) {
                oldCard.classList.add('rejected');
                oldCard.classList.remove('interview');
                oldCard.querySelector('.currentStatus').innerHTML = 'Rejected';
            }
        })
